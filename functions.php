...
function stier_scripts() {
	...
	if (is_singular('project')) {
		wp_enqueue_style( 'fancybox-style', get_stylesheet_directory_uri() . '/assets/dist/vendor/fancybox.css', '5.0.36', 'all');
		wp_enqueue_script( 'fancybox-script', get_template_directory_uri() . '/assets/dist/vendor/fancybox.js', array(), '', true);
    }
